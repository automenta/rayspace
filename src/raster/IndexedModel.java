...
public class IndexedModel
{
	...
	public void CalcTangents()
	{
		for(int i = 0; i < m_indices.size(); i += 3)
		{
			...
			float deltaU1 = m_texCoords.get(i1).x() - m_texCoords.get(i0).x();
			float deltaV1 = m_texCoords.get(i1).y() - m_texCoords.get(i0).y();
			float deltaU2 = m_texCoords.get(i2).x() - m_texCoords.get(i0).x();
			float deltaV2 = m_texCoords.get(i2).y() - m_texCoords.get(i0).y();

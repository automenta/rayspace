...
public class Matrix4f
{
	...
	public Vector4f transform(Vector4f r, Vector4f p)
	{
		return p.set(m[0][0] * r.x() + m[0][1] * r.y() + m[0][2] * r.z() + m[0][3] * r.w(),
		                    m[1][0] * r.x() + m[1][1] * r.y() + m[1][2] * r.z() + m[1][3] * r.w(),
		                    m[2][0] * r.x() + m[2][1] * r.y() + m[2][2] * r.z() + m[2][3] * r.w(),
							m[3][0] * r.x() + m[3][1] * r.y() + m[3][2] * r.z() + m[3][3] * r.w());
	}
        
	@Deprecated public Vector4f Transform(Vector4f r) 	{
            return transform(r, new Vector4f());
	}
        
	public Matrix4f Mul(Matrix4f r, Matrix4f res) {
	...
	@Deprecated public Matrix4f Mul(Matrix4f r)
	{
            return Mul(r, new Matrix4f());
	}
